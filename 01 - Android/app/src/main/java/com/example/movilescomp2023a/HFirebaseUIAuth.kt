...
class HFirebaseUIAuth : AppCompatActivity() {
    ...
    fun seLogeo( // cuando se logean otros usuarios
        res: IdpResponse
    ){
        ...
        tvBienvenido.text =  FirebaseAuth.getInstance().currentUser?.displayName//res.user.name // ponemos el nombre en el texto
